 ...
 * ****************************************************************
 */
public class RenterInfoBoundaryCallback extends PagedList.BoundaryCallback<RenterInfoEntity> {
    ...
    public RenterInfoBoundaryCallback(HandleResponseCallback callback, int pageSize, int initialLoadPage,
    ...
    public void onItemAtFrontLoaded(@NonNull RenterInfoEntity itemAtFront) {
    }

    /**
     * User reached to the end of the list.
     */
    public void onItemAtEndLoaded(@NonNull RenterInfoEntity itemAtEnd) {
    ...
    public interface HandleResponseCallback {
        void insertResultIntoDb(List<RenterInfoEntity> response);
    }
}
